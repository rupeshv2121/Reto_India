  ...
  return (
    <div className="about-page">
      ...
      <section className="why-join-section">
        ...
        <div className="content">
          ...
          <p>
            ...
            their work. By joining us, you're not just buying a product; you're
            becoming part of a movement to uplift lives, preserve traditional
            craftsmanship, and connect with our roots.
          </p>
        </div>
      </section>
      ...
      <section className="movement-section">
        <h2>What is our <span className="movement">Movement?</span></h2>
        <p>
      ...
      <section className="cards-section">
        ...
        <div className="card">
          ...
          <p>
            ...
            To Promoting Sustainability And Reducing The Environmental Impact
            Of Mass Production.
          </p>
          <button>Read More</button>
        </div>
