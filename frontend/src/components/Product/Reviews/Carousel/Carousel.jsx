...
import rvimg from './rvimg.png'
import rvimg1 from './rvimg1.png'
import StarRateIcon from '@mui/icons-material/StarRate';
const Carousel = ({ data }) => {
  const swiperRef = useRef(null); 
  
  return (
    <div className="review_box relative w-4/5 flex justify-center px-2" data-carousel="static">
        ...
        >
          {data.map((ele, index) => (
            <SwiperSlide key={index} className="select-none">
              <div className="scroll_style  duration-1000 flex p-3 rounded-lg text-white flex-shrink-0  h-auto" style={{ backgroundColor: "#222831" }} >
                ...
                <div className="p-3">
                  ...
                  <div className="customer_section ">
                    ...
                    <div className="img_section flex w-full my-2 overflow-auto ">
                      <img src={`http://localhost:3000${ele.image}`} alt="Uploaded Review" />
                    </div>
