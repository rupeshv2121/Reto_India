  ...
  return (
    <div className='tracking_container'>
        ...
        <div className="track-box">
          ...
          {show_dmd ?  <div className='diamond-div'>

              <img className='diamond'
              src="https://static.vecteezy.com/system/resources/previews/001/198/313/non_2x/diamond-png.png" alt="diamond"/>
            </div> :
           ...
           <div className='divtext'>Order delivered Successfully</div>
            ...
            <div>
                <form className='order-form' onSubmit={(e)=>{handleClick(e);}}>
                    <label for="order-id">Your Order ID</label>
                    <input type="text" id="order-id" name="order-id" placeholder="dmd-asxxyy-zz..." required/>
                    <label for="registration">Registration No</label>
                    <input type="text" id="registration" name="registration" placeholder="registartion no..." required/>
                    <label for="order-status">Order Status</label>
                    <input type="text" id="order-status" name="order-status" placeholder="Order status.." required/>
                    <label for="details">Order Details</label>
                    <textarea id="details" rows="5" name="details" placeholder="Write details..." required/>
                    <button type='submit' className='btn'>Track Order</button>
                    </form>
